...
public interface EmpresaTelefoniaInterfaz {
    ...
    boolean darDeAltaLlamada(String nif, String numDestino, Calendar fecha, int duracion);
    ...
    List<Factura> mostrarFactura(String nif, int codFactura)  throws ExcepcionListaFacturasVacia;
